package com.education.system.dateTest;
...
public class ISODateTest {
	...
	public void testDateFormat() throws Exception {
		...
		log.debug("LocalDateTime format(DateTimeFormatter.ISO_LOCAL_DATE_TIME)@"
		...
		log.debug("OffsetDateTime format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)@"
				+ offsetDate.format(DateTimeFormatter.ISO_OFFSET_DATE_TIME));
		...
		log.debug("ZonedDateTime format(DateTimeFormatter.ISO_ZONED_DATE_TIME)@"
				+ zonedDate.format(DateTimeFormatter.ISO_ZONED_DATE_TIME));
		...
		assertEquals("local date should be equals", date.format(DateTimeFormatter.ISO_LOCAL_DATE_TIME),
				localDateNode.textValue());
		assertEquals("offsetDate date should be equals", offsetDate.format(DateTimeFormatter.ISO_OFFSET_DATE_TIME),
				offsetDateNode.textValue());
		assertEquals("zonedDate date should be equals", zonedDate.format(DateTimeFormatter.ISO_ZONED_DATE_TIME),
				zonedDateNode.textValue());
